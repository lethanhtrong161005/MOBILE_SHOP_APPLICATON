 ...
 */
@WebServlet(name="StaffController", urlPatterns={Const.STAFF_URL, 
                                                 Const.STAFF_SEARCH_URL
                                                })
public class StaffController extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
       ...
       }else if(Const.STAFF_SEARCH_URL.endsWith(path)){
    ...
    //Load Mobile List
    private void loadMobileList(HttpServletRequest req, HttpServletResponse resp)
    throws ServletException, IOException{
        List<Mobile> mobiles = mobileService.getAllMobile();
        if(mobiles != null){
            req.setAttribute("mobiles", mobiles);
        }else{
            req.setAttribute("message", "Mobile empty");
